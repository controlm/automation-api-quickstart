...
"ProcessData": {
    ...
    "SparkScript": "file:///home/[USER]/automation-api-quickstart/saas-control-m/101-running-hadoop-spark-job-flow/processData.py",

    "Arguments": [
        "file:///home/[USER]/automation-api-quickstart/saas-control-m/101-running-hadoop-spark-job-flow/processData.py",
        "file:///home/[USER]/automation-api-quickstart/saas-control-m/101-running-hadoop-spark-job-flow/processDataOutDir"
    ],

    "PreCommands" : {
        "Commands" : [
            { "rm":"-R -f file:///home/[USER]/automation-api-quickstart/saas-control-m/101-running-hadoop-spark-job-flow/processDataOutDir" }
        ]                   
    }
}
```
