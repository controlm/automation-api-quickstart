...
3.  Change the example jobs (.json) in /resource to match your environment Control-M Server and Agent's host (usually the same of the hostname where Control-M is installed)
